...
export default function TeamDetailClient({
  ...
  // ホーム/アウェイ比較データを計算
  const homePPG = homeStanding && homeStanding.playedGames > 0
    ? homeStanding.points / homeStanding.playedGames
    : null;
  const awayPPG = awayStanding && awayStanding.playedGames > 0
    ? awayStanding.points / awayStanding.playedGames
    : null;
  const homeWinRate = homeStanding && homeStanding.playedGames > 0
    ? Math.round(homeStanding.won / homeStanding.playedGames * 100)
    : null;
  const awayWinRate = awayStanding && awayStanding.playedGames > 0
    ...
    <div className="max-w-5xl mx-auto px-4 py-6 space-y-4">
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded shadow-sm p-5">
        ...
        {(coachName || venue) && (
          <div className="flex flex-wrap gap-6 mt-4 pt-4 border-t border-gray-100 dark:border-gray-800">
            {coachName && (
              <div>
                <div className="text-xs text-gray-400 dark:text-gray-500">監督</div>
            ...
            {venue && (
              <div>
                <div className="text-xs text-gray-400 dark:text-gray-500">ホームスタジアム</div>
                <div className="text-sm font-medium text-gray-900 dark:text-gray-100 mt-0.5">
                  {venue}
                </div>
              </div>
      ...
      {tab === "analysis" && (
        <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center pt-1 border-t border-gray-100 dark:border-gray-800">
                      ...
                      <span className={`font-mono tabular-nums font-bold ${teamXgStats.xGDiff >= 0 ? "text-green-600" : "text-red-500"}`}>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center pt-1 border-t border-gray-100 dark:border-gray-800">
                      ...
                      <span className={`font-mono tabular-nums font-bold ${teamXgStats.xGADiff >= 0 ? "text-green-600" : "text-red-500"}`}>
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded shadow-sm p-5">
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div className="bg-gray-50 dark:bg-gray-800 rounded p-3">
                  <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">試合あたり得点</div>
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded p-3">
                  <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">試合あたり失点</div>
                  <div className="text-2xl font-bold font-mono tabular-nums text-gray-900 dark:text-gray-100">
                    {(totalStanding.goalsAgainst / played).toFixed(2)}
                  </div>
                </div>
                <div className="bg-gray-50 dark:bg-gray-800 rounded p-3">
                  <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">勝点/試合 (PPG)</div>
                  <div className="text-2xl font-bold font-mono tabular-nums text-violet-600">
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded shadow-sm p-5">
              ...
              {homePPG !== null && awayPPG !== null && (
                <div className="mt-3 text-center text-xs text-gray-400 dark:text-gray-500">
                  ホーム/アウェイ PPG 差：
                  <span className={`font-mono tabular-nums font-semibold ml-1 ${
                    homePPG - awayPPG >= 0.5 ? "text-blue-600" :
                    awayPPG - homePPG >= 0.5 ? "text-orange-600" :
                    "text-gray-500"
                  }`}>
          ...
          {/* データが何もない場合のフォールバック */}
          {!teamProbabilities && !teamXgStats && topScorers.length === 0 && topAssisters.length === 0 && (
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded shadow-sm p-8 text-center text-sm text-gray-400 dark:text-gray-500">
              分析データを取得できませんでした
            </div>
          )}
        </div>
